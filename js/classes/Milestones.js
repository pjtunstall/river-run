...
export class Milestones {
  ...
  #createAll() {
    ...
    this.#add(1, 0, -20, "Microtask Checkpoint", "yellow");
    this.#add(1, 5, -45, "requestAnimationFrame Callbacks", "cyan");
    this.#add(0, -16, 12, "Style", "white");
    this.#add(0, -22, -12, "Layout", "orange");
    this.#add(0, 24, -24, "ResizeObserver Callbacks", "purple");
    this.#add(0, 21, -49, "IntersectionObserver Callbacks", "gold");
